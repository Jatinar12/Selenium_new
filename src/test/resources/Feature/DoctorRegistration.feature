Feature: Doctor Registration
  ...
  Scenario Outline:User navigates to the Doctor Registration and signs up
    Given user navigates to the <Page_Type>
...
#    When user clicks on the "Register" button
    ...
    Examples:
      | Name         | Email                     | Mobile_Number | Password   | Gender_Type | Page_Type           | Registration_Message    |
      | Hunter Brown | hunterbroweerrs@gmail.com | 941508299    | 9797@Qwerty | Male        | Doctor Registration | Signed up successfully! |
  ...
  Scenario Outline:User navigates to the Doctor Registration and signs up with invalid data
    ...
    And user enters value <Mobile_Number> in the mobile number input field
    And user enters value <Password> in the create password input field
    Then user can view message <Error_Message>
    Examples:
      | Name  | Email       | Mobile_Number| Page_Type           | Error_Message                                | Password | Gender_Type |
  ...
  Scenario Outline:User is not able to register with invalid password
    ...
    Examples:
      | Name      | Mobile Number | GenderType | Email       | Password       | Rule                                         | Page_Type           |
  ...
  Scenario Outline:User is not able to register with existing mobile number & email
    ...
    When user clicks on the "Register" button
    Then user can view message <Registration_Message>
    Then user enters value <Mobile Number> in the mobile number input field
    And user enters value <Email> in the email input field
    Then user can view message <Error Message>
    Examples:
      | Name         | Email                     | Mobile Number | Password    | Gender Type | Email              | Mobile Number | Page_Type           | Error Message                 | Registration_Message    |
      | Hunter Brown | huqnstewbrowqess@gmail.com| 9142310398    | 9797@Qwerty | Male        | test@testuser1.com | 9142310398    | Doctor Registration | Mobile number already exists! | Signed up successfully! |
      | Hunter Brown | test@testuser.com         | 9541108299    | 9797@Qwerty | Male        | test@testuser.com  | 9541308295    | Doctor Registration | Email already exists!         | Signed up successfully! |
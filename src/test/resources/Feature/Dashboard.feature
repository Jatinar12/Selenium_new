Feature: Dashboard
  ...
  Examples:
  | Page_Type | Item                           |
  | Homepage  | 50+ Specialities, 630+ Doctors |
...
#    When user clicks on the <SpecialityCard> card
#    Then the corresponding page appear with the expected elements: <Item>
#
#  Examples:
...
#    Given user navigates to <Page_Type> page
#    When user clicks on the <DoctorCard> card
#    Then the corresponding page appears with the expected elements: <Item>
#
#  Examples:
#  | Page_Type | DoctorCard      | Item                                                           |
